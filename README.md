...
<p><b>3.</b> Create configuration file in either "xml" or "json" format and put it on 
   ...
   <li>Make sure, that username, you use in your PostgreSQL connection string, defined as superuser (usually "postgres")<br> More info: <a href="http://www.postgresql.org/docs/current/static/sql-createrole.html">http://www.postgresql.org/docs/current/static/sql-createrole.html</a></li>
   </ul>
